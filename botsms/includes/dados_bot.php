...
// TOKEN DO BOT
define ('TOKEN_BOT', '5570881084:AAHoosgoXX_QZaUn0kme7kfS0EnUG1nGA2w');

// API KEY https://sms-activate.ru/en/api2
define ('KEY_SMS', '0aHFUW9swzz9S8Zmti3D5mOM4oJ8uxbG');
...
define ('PORCENTAGEM_LUCRO', 488.2); // %

// lista de ids de adms
define ('ADMS', [1669361447]);

define ('CHAT_ID_NOTIFICACAO', '-1002698605266'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','-1002698605266'); // grupo de bot
