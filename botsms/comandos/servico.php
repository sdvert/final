...
if (isset ($complemento)){
	...
	$valor_sms = valorSMS ($valor_real * 5.60 * 1.50, 2); // quanto vai custar esse sms, já convertido
	...
	$notas = [
		...
		"<em><b>Nota:</b> Entre no nosso canal @digitaljvbots, lá enviamos códigos de resgate.</em>",
		"<em><b>Nota:</b> Algum problema? Contate @leadsstoreejvbots para suporte!</em>",
		"<em><b>Nota:</b> <a href=\"https://www.youtube.com/watch?v=VRVMEkRLr1o&t=2s\">Veja como usar o bot</a></em>",
